...
public class NotSample extends Fragment {
    ...
    private NotSampleView galleryViewModel;

    public View onCreateView(@NonNull LayoutInflater inflater,
                             ViewGroup container, Bundle savedInstanceState) {
        galleryViewModel =
                ViewModelProviders.of(this).get(NotSampleView.class);
        View root = inflater.inflate(R.layout.fragment_not_sample, container, false);
        final TextView textView = root.findViewById(R.id.text_not_sample);
